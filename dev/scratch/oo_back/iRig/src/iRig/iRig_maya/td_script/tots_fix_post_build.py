        ...
        if cmds.objExists(side+'_Wing_Info'):
            ...
            if side == 'L':
                ...
                if cmds.objExists(neckSwitch):
                    ...
                    if not cmds.getAttr('C_Head_Ctrl.Follow', lock=True):
                    ...
                    if cmds.objExists("C_Neck_End_Ctrl.Follow"):
                        cmds.deleteAttr("C_Neck_End_Ctrl.Follow")
                    if cmds.objExists('C_Head_Pin_Ctrl'):
                        if not cmds.objExists('C_Head_Pin_Ctrl_Offset_Grp'):
                            if cmds.objExists('C_Head_Pin_Ctrl_Cons'):
                                cmds.rename('C_Head_Pin_Ctrl_Cons', 'C_Head_Pin_Ctrl_Cns_Grp')
                                cmds.rename('C_Head_Pin_Ctrl_Offset', 'C_Head_Pin_Ctrl_Offset_Grp')
                    else:
                    ...
                    if cmds.objExists('C_Neck_End_Ctrl_Cns_Grp_parentConstraint1'):
                        cmds.delete('C_Neck_End_Ctrl_Cns_Grp_parentConstraint1')
                    cmds.parentConstraint('C_Head_Pin_Ctrl_Follow_Driver_Orient_Tfm', 'C_Neck_End_Ctrl_Cns_Grp', maintainOffset=True)
                    if cmds.objExists('Head_Pin_Cond'):
                        cmds.delete('Head_Pin_Cond')
    ...
    for side in sides:
        ...
        if cmds.objExists(side+'_Wing_Info'):
            ...
            if side == 'L':
                ...
                if cmds.objExists('Face_Tweaks_Grp'):
                    # Add throat controls
