...
def createButton(lay=None, name='newButton', command=None, iconPath=None, btnSize=None, annotation=None):
    # button
...
def btnsFromJson(layout, config, btnSize=None, icon_dir=None):
    ...
    for cat, btns_data in categoriesAndBtns_data.items():
        ...
        for btnName, btn_data in btns_data.items():
            ...
            btn = createButton(name=btnName, iconPath=iconPath, btnSize=btnSize, annotation=annotationString)
