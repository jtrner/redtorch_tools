...
def nodeInitializer():
    ...
    myCustomNode.aNumericAttrInt = numericAttrInt.create("numericAttrInt", "nai", OpenMaya.MFnNumericData.kInt,
                                                         kDefaultNumericAttrIntValue)
    ...
    myCustomNode.aNumericAttrFloat = numericAttrFloat.create("numericAttrFloat", "naf", OpenMaya.MFnNumericData.kFloat,
                                                             kDefaultNumericAttrFloatValue)
