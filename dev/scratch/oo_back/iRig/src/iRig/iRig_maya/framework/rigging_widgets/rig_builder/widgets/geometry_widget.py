...
from rigging_widgets.rig_builder.widgets.mesh_face_widget import MeshFaceWidget
from rigging_widgets.rig_builder.widgets.mesh_widget import MeshWidget
from rigging_widgets.rig_builder.models.geometry_model import GeometryModel
...
class GeometryWidget(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mesh_widget = MeshWidget(self)
        self.mesh_face_widget = MeshFaceWidget(self)
        self.button_layout.addStretch()
        self.vertical_layout.addLayout(self.button_layout)
        self.vertical_layout.addLayout(self.stacked_layout)
        self.stacked_layout.addWidget(self.mesh_widget)
        self.stacked_layout.addWidget(self.mesh_face_widget)
