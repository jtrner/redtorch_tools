...
class BipedSpineIkGuide(ChainGuide):
    ...
    def __init__(self, **kwargs):
        super(BipedSpineIkGuide, self).__init__(**kwargs)
    ...
    def create(cls, controller, **kwargs):
        ...
        this = super(BipedSpineIkGuide, cls).create(controller, **kwargs)
        return this

    def get_toggle_blueprint(self):
        blueprint = super(BipedSpineIkGuide, self).get_toggle_blueprint()
...
class BipedSpineIk(Part):
    ...
    def create(cls, controller, **kwargs):
        ...
        this = super(BipedSpineIk, cls).create(controller, **kwargs)
        ...
        for handle in [lower_torso_handle, upper_torso_handle, center_handle]:
            root.add_plugs(
                [
                    handle.plugs['tx'],
                    handle.plugs['ty'],
