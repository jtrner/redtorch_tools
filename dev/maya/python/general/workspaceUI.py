...
from python.general import workspaceUI
reload(workspaceUI)
workspaceUI.launch()
...
class UI(QtWidgets.QDialog):
    ...
    def populateProjectTab(self):
        ...
        # resolution
        self.resolution_box = qtLib.createCB(
        ...
        self.openScene_btn = qtLib.MenuButton('Open')
        buttons_vl.layout().addWidget(self.openScene_btn)
        self.openScene_btn.setEnabled(False)

        self.openScene_btn.addMenuAction('Open', self.openScene)
        self.openScene_btn.addMenuAction('Import', self.importScene)
        self.openScene_btn.addMenuAction('Reference', self.referenceScene)
