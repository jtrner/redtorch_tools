"""
From: http://www.polygon.me/2017/06/collision-based-deformer.html

simply create two polygon spheres. Move the second away from the first, select the first and run the code below.  
import maya.cmds as mc  
 
mc.delete(mc.ls(type='collisionDeformer'))  
mc.flushUndo()  
mc.unloadPlugin('collisionDeformer.py')  
mc.loadPlugin('collisionDeformer.py')  
mc.deformer(type='collisionDeformer')  
mc.connectAttr('pSphere2.worldMesh', 'collisionDeformer1.colliderTarget')  
mc.connectAttr('pSphere2.matrix', 'collisionDeformer1.colliderMatrix')  
mc.connectAttr('pSphere2.boundingBox.boundingBoxSize.boundingBoxSizeX', 'collisionDeformer1.colliderBoundingBox.colliderBoundingBoxX')  
mc.connectAttr('pSphere2.boundingBox.boundingBoxSize.boundingBoxSizeY', 'collisionDeformer1.colliderBoundingBox.colliderBoundingBoxY')  
mc.connectAttr('pSphere2.boundingBox.boundingBoxSize.boundingBoxSizeZ', 'collisionDeformer1.colliderBoundingBox.colliderBoundingBoxZ')
