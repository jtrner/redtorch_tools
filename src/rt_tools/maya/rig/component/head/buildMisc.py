...
class BulidMisc(miscTemplate.MiscTemplate):
    ...
    def build(self):
        ...
        self.nasalLabialCtlOriGrp = mc.createNode('transform', name = self.side + '_nasalLabialCtlOri_GRP')
        trsLib.match(self.nasalLabialCtlOriGrp,self.miscJnts[5])
        self.cheekCtlOriGrp = mc.createNode('transform', name = self.side + '_cheekCtlOri_GRP')
        trsLib.match(self.cheekCtlOriGrp,self.miscJnts[4])
        self.browFleshCtlOriGrp = mc.createNode('transform', name = self.side + '_browFleshCtlOri_GRP')
        trsLib.match(self.browFleshCtlOriGrp,self.miscJnts[3])
        self.orbitalUpperCtlOriGrp = mc.createNode('transform', name = self.side + '_orbitalUpperCtlOri_GRP')
        trsLib.match(self.orbitalUpperCtlOriGrp,self.miscJnts[6])
        self.earCtlOriGrp = mc.createNode('transform', name = self.side + '_earCtlOri_GRP')
        trsLib.match(self.earCtlOriGrp,self.miscJnts[-3])
        self.nasalCtlOriGrp = mc.createNode('transform', name = self.side  + '_nasalCtlOri_GRP')
        trsLib.match(self.nasalCtlOriGrp,self.miscJnts[2])
        self.orbitalLowerCtlOriGrp = mc.createNode('transform', name = self.side + '_orbitalLowerCtlOri_GRP')
        trsLib.match(self.orbitalLowerCtlOriGrp,self.miscJnts[7])
        self.appleCtlOriGrp = mc.createNode('transform', name = self.side + '_appleCtlOri_GRP')
        trsLib.match(self.appleCtlOriGrp,self.miscJnts[1])
        self.cheekLowerCtlOriGrp = mc.createNode('transform', name = self.side + '_cheekLowerCtlOri_GRP')
