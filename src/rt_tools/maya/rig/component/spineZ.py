...
class SpineZ(template.Template):
    ...
    def __init__(self, side = 'C' , prefix = 'spine', numJnts = 6, **kwargs):
        ...
        super(SpineZ, self).__init__(**kwargs)

    def createBlueprint(self):
        super(SpineZ, self).createBlueprint()
    ...
    def createSettings(self):
        ...
        """
        super(SpineZ, self).createSettings()
